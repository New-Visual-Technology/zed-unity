...
/// </summary>
public class BoardObject_MoveToBoardSimple : BoardObject
{
    public override void BoardDetectedSingle(Vector3 worldposition, Quaternion worldrotation)
    {
    ...
    public override void BoardNotDetected()
    {
