...
public abstract class BoardObject : MonoBehaviour
{
    ...
    {
        ZEDArUcoBoardDetectionManager.RegisterBoard(this); //Tells ZEDArUcoDetectionManager to tell us when our marker is detected. 
    }
    ...
    public virtual void BoardDetectedSingle(Vector3 worldposition, Quaternion worldrotation) { }
    ...
    /// </summary>
    public virtual void BoardNotDetected() { }
    ...
    public virtual void BoardDetectedAll(List<sl.Pose> worldposes) { }

    protected virtual void OnDestroy()
    {
        ZEDArUcoBoardDetectionManager.DeregisterBoard(this);
    }
}
