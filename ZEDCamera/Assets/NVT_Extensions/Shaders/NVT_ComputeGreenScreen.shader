...
Shader "NVT/Compute GreenScreen"
{
    Properties
    {
        ...
        _Range("Color Range", Range(0.0, 1.0)) = 0.0
    }
    ...
    SubShader
    {
        Pass
        {
            ...
            float4 frag(v2f i) : SV_Target
            {
                ...
                float3 workpiece = tex2D(_WorkpieceMaskTex, uv).bgr;
                ...
                float3 _keyColor = RGBtoYUV(_KeyColor.rgb);
